...
% 1st. author
 \alignauthor
 William Waites\we\wh, James Sweet\wh, Roger Baig\wg, Peter Buneman\we,\\
 Marwan Fayed\ws, Michael Fourman\we, Richard Simmons\ws \\
 \affaddr{{\we}University of Edinburgh, {\wh} HUBS \textsc{c.i.c}, {\wg}guifi.net, {\ws}University of Stirling}\\
 \email{\{ww,opb,mfourman\}@inf.ed.ac.uk, james@hubs.net.uk, roger.baig@guifi.net, mmf@cs.stir.ac.uk, r.a.simmons@stir.ac.uk}
...
\subsection{HUBS C.I.C.}\input{hubs}

\section{RemIX Architecture} \label{sec:arch} \input{arch}

\section{RemIX Deployment in Scotland} \label{sec:impl} \input{scotland}
