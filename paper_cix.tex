...
\usepackage{verbatim, xcolor}%, enumitem}
\usepackage{acronyms}
\usepackage{natbib}
\def\bibfont{\small}
\def\bibsep{0pt}
...
% 1st. author
 \alignauthor
  William Waites\we\wh, James Sweet\wh, Peter Buneman\we,\\
 Marwan Fayed\ws, Gordon Hughes\we\\
 \affaddr{{\we}University of Edinburgh, {\wh}HUBS \textsc{c.i.c},
   {\ws}University of Stirling}\\
 {\email{\small Corresponding authors: wwaites@tardis.inf.ed.ac.uk, opb@inf.ed.ac.uk, mmf@cs.stir.ac.uk}}
